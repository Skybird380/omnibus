...
def setup():
    Sensor("Big Omega S-Type", "ai16", 0.2, Connection.DIFFERENTIAL,
    ...
    Sensor("Omega S-Type - Ox Tank Mass", "ai17", 0.2, Connection.DIFFERENTIAL,
            # calibrated 13/3/2022 @ 10V, now running at 12
            LinearCalibration(3025.7/10*12, -1.37, "kg"))
    Sensor("Annemometer", "ai19", 5, Connection.SINGLE,
            # According to adafruit 0.4V = 0 m/s, 2V = 32.4 m/s
            LinearCalibration(20.25, -8.1, "m/s"))
